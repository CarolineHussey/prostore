...
const TARGET_DATE = new Date("2026-11-30T00:00:00");
    ...
    return (
      <section className="grid grid-cols-1 md:grid-cols-2 my-20">
        <div className="flex flex-col gap-2 justify-center">
          ...
          <p>
            This deal has now ended! See what fabulous products we&apos;ve got
            in store now!
          </p>
        ...
        <div className="flex justify-center">
          <Image src={promoImage} alt="Promo image" width={300} height={200} />
        </div>
      </section>
    );
  }
