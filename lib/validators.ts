...
export const insertProductSchema = z.object({
  ...
  stock: z.coerce.number(), //coerce string to number
...
export const signUpFormSchema = z
  .object({
    ...
    confirmPassword: z
      .string()
      .min(6, "Confirm password. Password must be at least 6 characters"),
  })
...
export const paymentMethodSchema = z
  ...
  .refine((value) => PAYMENT_METHODS.includes(value.type), {
    path: ["type"], //field where the message will be output
