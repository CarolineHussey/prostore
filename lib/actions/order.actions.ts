...
//approve order and update order to paid
export async function approvePayPalOrder(
  orderId: string, //uuid in database
  ...
  try {
    ...
    if (
      ...
      throw new Error("Error in PayPal payment transaction.");
    }
    //updatee order to paid
...
async function updateOrderToPaid({
  ...
  await prisma.$transaction(async (tx) => {
    //iterate through products and update stock
  ...
  //get updated order after transaction completed
  ...
  if (!updatedOrder) throw new Error("Order was not updated");
}
